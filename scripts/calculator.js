...
var atomicMass = [["H", 1.00794], ["He", 2.0026], ["Li", 6.941], ["Be", 9.0122], ["B", 10.811], ["C", 12.0107], ["N", 14.0067], ["O", 15.9994], ["F", 18.9984], ["Ne", 20.1797], ["Na", 22.1797], ["Mg", 24.305], ["Al", 26.9815], ["Si", 28.0855], ["P", 30.9738], ["S", 32.066], ["Cl", 35.45], ["Ar", 39.948], ["K", 39.0983], ["Ca", 40.078], ["Sc", 44.9559], ["Ti", 47.867], ["V", 50.9415], ["Cr", 51.9961], ["Mn", 54.938], ["Fe", 55.845], ["Co", 58.9332], ["Ni", 58.6934], ["Cu", 63.546], ["Zn", 65.38], ["Ga", 69.723], ["Ge", 72.63], ["As", 74.9216], ["Se", 78.96], ["Br", 79.904], ["Kr", 83.798], ["Rb", 85.4678], ["Sr", 87.62], ["Y", 88.9059], ["Zr", 91.224], ["Nb", 92.9064], ["Mo", 95.96], ["Tc", 97.907], ["Ru", 101.07], ["Rh", 102.9055], ["Pd", 106.42], ["Ag", 107.8682], ["Cd", 112.411], ["In", 114.818], ["Sn", 118.71], ["Sb", 121.76], ["Te", 127.6], ["I", 126.9045], ["Xe", 131.29], ["Cs", 132.9055], ["Ba", 137.327], ["La", 138.9055], ["Hf", 178.49], ["Ta", 180.9479], ["W", 183.84], ["Re", 186.207], ["Os", 190.23], ["Ir", 192.217], ["Pt", 195.084], ["Au", 196.966], ["Hg", 200.59], ["Tl", 204.3833], ["Pb", 207.2], ["Bi", 208.9804], ["Po", 208.98], ["At", 210], ["Rn", 222], ["Fr", 223], ["Ra", 226.0254], ["Ac", 227.0278], ["Rf", 261], ["Db", 262], ["Sg", 263], ["Bh", 267], ["Hs", 269], ["Mt", 278], ["Ds", 281], ["Rg", 281], ["Cn", 262], ["Nh", 283], ["Fl", 289], ["Mc", 289], ["Lv", 293], ["Ts", 294], ["Og", 294]]
atomicMass = atomicMass.sort(function (a, b) {
...
function calculateMolarMass(str) {
  ...
  atomicMass.forEach(function (item) {
    str = str.replaceAll(item[0], "+".concat(item[1], "*"));
  });
  ...
  var res = calculate(str.split("x"));
  document.getElementById("calculations").innerHTML += res;
  document.querySelector("#calculator .result").innerHTML = formula + " = " + res;

  function calculate(arr) {
    while (arr.includes("(")) {
      var leftI = arr.indexOf("(");
      var rightI = arr.indexOf(")");
      arr.splice(leftI, 2, calculate(arr.splice(leftI + 1, rightI - leftI - 1)));
    }
